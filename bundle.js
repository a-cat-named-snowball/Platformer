...
const __default = [
    ...
    2,
    2,
    "Hello! Walk towards the green door. Good things will come of it.",
    `
	0000000000000000
	0..............0
	0............e.0
    ...
    1,
    1,
    "I wonder how you're going to get up here.",
    `
	0000000000000000
	0....G.........0
	0....G.........0
    ...
    6,
    1,
    "Would you mind moving this box for me?\nPut it over there on that button.",
    `
	0000000000
	0..v.....0
	0g+......0
    ...
    0,
    -1,
    "Teleportation can also cause death.",
    `
	0000000000000000
	0..............0
	0........i.....0
    ...
    0,
    8,
    "Studies show that submersion in lava can cause death.",
    `
	00000000000000000
	0.B.0...g.......0
	0.Be0...+.......0
    ...
    0,
    7,
    "Please don't solve this too quickly. It took a long time to make.",
    `
	00000000000
	00.vvvvv.00
	0.........0
    ...
    2,
    2,
    "This level looks scary, doesn't it?",
    `
	000000000000000000
	0vvvvvvvvvvvvvv000
	0..............000
    ...
    1,
    2,
    "Sometimes the doors work against you.",
    `
	00000000000000000
	0+000000xx0000x00
	0+000000..0000..0
    ...
    5,
    12,
    "It's like the Stairmaster... except with more lava.",
    `
	00000000000
	0x.v.x.v.x0
	0.........0
    ...
    0,
    14,
    "The world's least cost effective elevator.",
    `
	00000000000000000
	000C0000000000000
	0......R......000
    ...
    0,
    8,
    "Boxes can be teleported. But they don't like it.",
    `
    ...
    0,
    9,
    "What happens if one portal is in the floor and another is right below it?",
    `
	000000000000000
	0s.........v.e0
	00000.....00000
    ...
    0,
    15,
    "Two levels from now go through the yellow portal.",
    `
    ...
    0,
    13,
    "Good thing you have a jet pack.",
    `
	000000000000000000000000000000000
    ...
    0,
    11,
    "Memory can make this level much easier.",
    `
	00000000000000000
	0.s0xxxxxxxxxxxx0
	0.0000....000xxx0
    ...
    0,
    -1,
    "Precision jet pack control will be required.", 
];
...
var LevelManager = function() {
    ...
    this.levels = parse_levels(__default);
};
...
Map.prototype.playerPhysics = function(player) {
    ...
    if (part != 0 && Math.abs(prevy) >= 10) {
        ...
        for(var i = 0; i < 10; i++){
            this.addParticle(new Particle(this.player.x + this.player.width / 2, this.player.y + yoff, Math.random() * 4 - 2, -3 * part, 0, .4 * part, 15, "dust.png"));
        }
    }
    if (this.player.jumping) {
        ...
        for(var i = 0; i < 5; i++){
            ...
            this.addParticle(new Particle(this.player.x + this.player.width / 2 - this.player.direction * 5, this.player.y + yoff, this.player.vx / 2 + Math.random() * 2 - 1, this.player.vy / 2 - Math.random() * 2, Math.random() * .2 - .1, (1 - Math.random() * .2) * this.y_gravity, 15, im));
        }
    }
...
Artist.prototype.preRenderTiles = function(map) {
    ...
    for(var y = 0; y < map.height; y++){
        for(var x = 0; x < map.width; x++){
            ...
            if (map.getAt(x, y) === "0") {
                mask = 0;
                if (map.getAt(x, y - 1) === "0") {
                    mask += 1;
                }
                if (map.getAt(x + 1, y) === "0") {
                    mask += 2;
                }
                if (map.getAt(x, y + 1) === "0") {
                    mask += 4;
                ...
                mask = 0;
                if (map.getAt(x, y - 1) === "x" || map.getAt(x, y - 1) === "0") {
                    mask += 1;
                }
                if (map.getAt(x + 1, y) === "x" || map.getAt(x + 1, y) === "0") {
                    mask += 2;
                }
                if (map.getAt(x, y + 1) === "x" || map.getAt(x, y + 1) === "0") {
                    mask += 4;
...
(function() {
    ...
    ts.beginGame = (function() {
        ...
        this.artist.preload([
            "green_button_activate.png",
            "red_button_activate.png",
            "blue_button_activate.png",
            "lava_tile.jpg",
            "floor_tile.jpg",
            "fire.png",
            "dust.png",
            "smoke.png",
            "cyan_teleporter.png",
            "yellow_teleporter.png",
            "purple_teleporter.png",
            "open.png",
            "dark.jpg",
            "grav_up.png",
            "grav_down.png",
